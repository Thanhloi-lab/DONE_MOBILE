...
const HorizontalProjectCard = ({ containerStyle, imageStyle, item, onPress }) => {
    return (
        <TouchableOpacity
            style={{
        ...
        >
            ...
            <View style={{ flex: 1, padding: 15, }} numberOfLines={1}>
                ...
                {/* description */}
                <Text style={{ color: COLORS.darkGray1, ...FONTS.body4, fontSize: 12 }} numberOfLines={1}>
                    {item.mailUserCreateProject}
                </Text>

                <Text style={{ marginTop: SIZES.base, ...FONTS.h3, fontSize: 14 }} numberOfLines={1}>

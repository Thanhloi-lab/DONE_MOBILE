...
export async function getGroupById(id) {
    let response = await fetch(`http://192.168.1.4:50003/api/Groups/getById?Id=${id}`);
    let data = await response.json();
    return data;
};
...
export async function deleteGroup(data) {
    // Default options are marked with *
    const response = await fetch(`http://192.168.1.4:50003/api/Groups/removeGroup`, {
        method: 'PUT', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export async function addGroupMembers(data) {
    // Default options are marked with *
    //console.log(data);
    const response = await fetch(`http://192.168.1.4:50003/api/Groups/addMember`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export async function removeGroupMembers(data) {
    // Default options are marked with *
    //console.log(data);
    const response = await fetch(`http://192.168.1.4:50003/api/Groups/removeMember`, {

...
export async function updateStatus(data) {
    // Default options are marked with *
    // console.log(data);
    const response = await fetch(`http://192.168.1.4:50003/api/Tasks/updateStatus`, {
        method: 'PUT', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export async function deleteTask(data) {
    // Default options are marked with *
    const response = await fetch(`http://192.168.1.4:50003/api/Tasks/removeTask`, {
        method: 'PUT', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export async function addTaskMembers(data) {
    // Default options are marked with *
    //console.log(data);
    const response = await fetch(`http://192.168.1.4:50003/api/Tasks/addMember`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export async function removeTaskMembers(data) {
    // Default options are marked with *
    //console.log(data);
    const response = await fetch(`http://192.168.1.4:50003/api/Tasks/removeMember`, {
...
export async function allTaskByProject(projectId, userId) {
    ...
    let response = await fetch(`http://192.168.1.4:50003/api/Tasks/getByProject?idProject=${projectId}&idUser=${userId}`);
    let data = await response.json();
    return data;
};
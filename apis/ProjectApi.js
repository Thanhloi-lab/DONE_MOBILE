...
export async function allProjectByGroupId(id) {
    let response = await fetch(`http://192.168.1.4:50003/api/Projects/getByGroup?idGroup=${id}`);
    let data = await response.json();
    return data;
};
...
export async function deleteProject(data) {
    // Default options are marked with *
    const response = await fetch(`http://192.168.1.4:50003/api/Projects/removeProject`, {
        method: 'PUT', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export async function addProjectMembers(data) {
    // Default options are marked with *
    //console.log(data);
    const response = await fetch(`http://192.168.1.4:50003/api/Projects/addMember`, {
        method: 'POST', // *GET, POST, PUT, DELETE, etc.
        mode: 'cors', // no-cors, *cors, same-origin
        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
        credentials: 'same-origin', // include, *same-origin, omit
...
export async function removeProjectMembers(data) {
    // Default options are marked with *
    //console.log(data);
    const response = await fetch(`http://192.168.1.4:50003/api/Projects/removeMember`, {
